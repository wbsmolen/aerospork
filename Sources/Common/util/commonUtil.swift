...
private let debugLogger = OSLog(subsystem: aeroSpaceAppId, category: "Debug")

public func debugLog(_ message: String, file: String = #file, function: String = #function, line: Int = #line) {
    // For now, always log in both debug and release builds
    // Config check can be added later in AppBundle where config is available
