...
# Check basic syntax
zsh -c 'autoload -Uz compinit; compinit; source ./.shell-completion/zsh/_aerospork'
fish -c 'source ./.shell-completion/fish/aerospork.fish'
not-outdated-bash -c 'source ./.shell-completion/bash/aerospork'
