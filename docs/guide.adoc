...
[source,bash]
----
brew install --cask bsmolen/tap/aerospace
----
...
You can also install specific previous https://github.com/wbsmolen/homebrew-tap/tree/main/Casks[pinned homebrew Casks versions]:
[source,bash]
----
brew install --cask bsmolen/tap/aerospace@0.12.0
----
...
Please post your use cases to https://github.com/wbsmolen/aerospork/issues/20[the issue] if you want other commands to get supported.
